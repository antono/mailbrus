# ui-path-routing Specification

## Purpose
Define how the SvelteKit frontend synchronises browser URL with the current navigation view using the History API, supporting deep links, reloads, browser back/forward, graceful fallback for invalid links, and offline navigation via the service worker.
