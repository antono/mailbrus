...
Provides a `MaildirReader` capability in `mailbrus-core` for listing and fetching messages from a local Maildir directory using io-maildir coroutines, with support for sorting by message headers.
