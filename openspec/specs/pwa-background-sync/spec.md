...
Define offline queueing and Background Sync for outgoing messages and read-state/deletion mutations, including conflict resolution and cross-browser fallbacks.
