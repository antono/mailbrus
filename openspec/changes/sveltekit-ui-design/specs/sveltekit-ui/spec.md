...
Define the full Mailbrus SvelteKit UI — all screens, components, interactions, and theming — as ported from the Claude Design handoff.

## Reference

- **`reference/REQUIREMENTS.md`** — authoritative product requirements; this spec is derived from it
- **`reference/screens.jsx`** — React prototype implementation of every component defined here
- **`reference/app.jsx`** — state machine and keyboard handler reference
- **`reference/styles.css`** — visual specification for all CSS classes referenced in scenarios
