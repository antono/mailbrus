// Mailbrus sample data — maildir-style accounts + folders + messages.

window.MAILBRUS_DATA = (function () {
  const accounts = [
    {
      id: "gmail",
  ...
  // dense, varied message set per (account, folder)
  const M = (from, addr, subject, preview, time, unread = false, flags = "", attachments) => ({
    from, addr, subject, preview, time, unread, flags, attachments,
  });
  const A = (name, size, mime) => ({ name, size, mime });
  ...
  const messages = {
    "gmail/inbox": [
      M("Maya Reyes", "maya@scratchpad.dev", "Q3 plan — quick reviews ready", "Added the doc to the team channel and pinged you for a quick review.", "2m", true, "F", [
        A("Q3-rollout-plan.pdf", 412_988, "application/pdf"),
        A("timeline-v3.png", 184_220, "image/png"),
      ]),
      ...
      M("Stripe", "no-reply@stripe.com", "Receipt from your subscription", "Invoice INV-209387 · €19.00 · paid on May 19, 2026", "Wed", false, "R", [
        A("INV-209387.pdf", 23_104, "application/pdf"),
      ]),
      ...
      M("Ana Larsen", "ana@flat.studio", "drawings for the readme", "Three options inline. Picked the middle one but happy to switch.", "May 13", false, "R", [
        A("readme-v1.png", 1_587_004, "image/png"),
        A("readme-v2.png", 1_811_440, "image/png"),
        A("readme-v3.png", 2_142_006, "image/png"),
        A("sources.zip", 4_290_010, "application/zip"),
      ]),
    ...
    "proton/inbox": [
      ...
      M("Tarmo K.", "tarmo@lehmus.ee", "raamatu mustand", "saadan PDF-i, vaata kui aega.", "1h", true, "", [
        A("chapter-2-draft.pdf", 982_330, "application/pdf"),
      ]),
    ...
    "proton/drafts": [
      M("Draft", "—", "to tarmo — feedback on chapter 2", "—", "today", false, "D"),
    ],
    "proton/archive": [
...
"What gets measured gets managed." — P. Drucker`,
  ...
  return { accounts, folders, messages, bodies };
})();
